Browser("Advantage Shopping").Page("Advantage Shopping").Link("Link").WaitProperty "innertext", "OUR PRODUCTS", 10000
...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("CartItems").Highlight
...
foo = 1
 ...
 @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("2")_;_script infofile_;_ZIP::ssf8.xml_;_
